...
class TrainView(View):
    def get(self, request):
        ...
        #max_articles = Entry.objects.aggregate(max_articles=Max(Sum()))
        stage = AuthorProfile.objects.aggregate(stage=('stage'))
        ...
        self.answer6 = Author.objects.filter(1 < stage['stage'] < 5)  # TODO Какие авторы имеют стаж от 1 до 5 лет?
